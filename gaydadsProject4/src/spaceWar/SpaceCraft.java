...
/**
 * Super class for all moving objects in the space game. Uniquely identifies each 
 * Spacecraft using a IP address and a port number. Maintains position and 
 * heading state for SpaceCraft objects.
 * 
 * @author bachmaer
 * @author opyrchal
 */
